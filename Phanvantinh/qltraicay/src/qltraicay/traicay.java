...
public class traicay extends JFrame {
	private JTable tb;
	...
	public traicay() {
		...
		panel_1.setBounds(511, 80, 504, 359);
		contentPane.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("TRÁI CÂY SẠCH");
		...
		JLabel lblNewLabel_1 = new JLabel("Tên Quả");
		lblNewLabel_1.setBackground(Color.MAGENTA);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_1.setBounds(10, 91, 61, 35);
		panel_1.add(lblNewLabel_1);
		
		textField = new JTextField("");
		textField.setBounds(122, 99, 111, 20);
		panel_1.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("Giá Cả");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_2.setBounds(10, 169, 46, 35);
		panel_1.add(lblNewLabel_2);
		
		textField_1 = new JTextField("");
		textField_1.setBounds(122, 170, 111, 20);
		...
		textField_2.setBounds(122, 251, 111, 20);
		panel_1.add(textField_2);
		textField_2.setColumns(10);
		
		JLabel lblNewLabel_4 = new JLabel("Nguồn Gốc");
		lblNewLabel_4.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_4.setBounds(0, 305, 61, 35);
		panel_1.add(lblNewLabel_4);
		
		textField_3 = new JTextField("");
		textField_3.setBounds(122, 313, 111, 20);
		panel_1.add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblNewLabel_5 = new JLabel();
		lblNewLabel_5.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_5.setBounds(271, 115, 228, 162);
		...
		panel_2.setBounds(10, 61, 491, 378);
		...
		panel_2.add(tableResult,BorderLayout.CENTER);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(240, 230, 140));
		panel_2.add(panel, BorderLayout.SOUTH);
		
		JButton btnNewButton_3 = new JButton("RESETS");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new insertFruit("","","","","","",true,traicay.this);
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new insertFruit(lblNewLabel_7.getText().toString(),textField.getText().toString(), textField_1.getText().toString(), textField_2.getText().toString(), textField_3.getText().toString(), lblNewLabel_6.getText().toString(), false,traicay.this);
