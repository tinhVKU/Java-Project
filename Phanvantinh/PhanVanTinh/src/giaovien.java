...
public class giaovien extends JFrame{
	...
	public giaovien() {
		...
		JTextField textField_2 = new HintTextField("Năm / Tháng / Ngày ");
		textField_2.setBounds(131, 76, 212, 20);
		contentPane.add(textField_2);
		
		JLabel lblNewLabel_4 = new JLabel("Trường");
		...
		JLabel lblNewLabel_8 = new JLabel("Mã giáo viên");
		...
		JLabel lblNewLabel_9 = new JLabel("Nhập mật khẩu");
		...
		JLabel lblNewLabel_10 = new JLabel("Nhập lại mật khẩu");
				...
				if(textField_9.getText().length()!=0&&textField_7.getText().length()!=0&&textField.getText().length()!=0
						...
						if(textField_8.getText().length()>=8) {
							if(!textField_9.getText().equals(textField_8.getText())) {
								JOptionPane.showInternalMessageDialog(null,"Mật khẩu không thống nhất");
							}
							else {
								if(tam==0) {
									try {
										...
										JOptionPane.showMessageDialog(null,"Lỗi ! Sai định dạng ngày");
										 
									}
									catch(Exception e5){
										e5.printStackTrace();
										System.out.println(e5.getMessage());
										JOptionPane.showInternalMessageDialog(null,"Đăng kí thành công");
										dispose();
										new asdf();
									} 
								...
								if(tam==1) {
									try {
										...
										Connection conn =DriverManager.getConnection("jdbc:mysql://localhost:3306/sinhvien","root","");
										Statement stm =conn.createStatement();
										String sqlString = "INSERT INTO `teacher` VALUES ('"+textField_7.getText()+"', '"+textField.getText()+"', '"+textField_1.getText()+"', 'Nữ', '"+textField_2.getText()+"', '"+textField_4.getText()+"', '"+textField_5.getText()+"', '"+textField_6.getText()+"')";
										stm.executeUpdate(sqlString);
										//stm.executeUpdate("insert into student values('"+textField_6.getText()+"','"+textField.getText()+"','"+textField_1.getText()+"','"+textField_1.getText()+"','"+textField_2.getText()+"','"+textField_4.getText()+"')");	
									}
...
//								new asdf();
							...
							JOptionPane.showInternalMessageDialog(null,"Mật khẩu chưa đủ 8 kí tự");
						}
					
				}
					else {
						JOptionPane.showInternalMessageDialog(null,"Vui lòng nhập đầy đủ thông tin");
					}
				}
			});
